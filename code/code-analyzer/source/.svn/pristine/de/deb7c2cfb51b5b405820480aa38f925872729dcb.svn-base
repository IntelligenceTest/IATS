...
public class DefaultPagination1<T> implements Pagination1<T> {

    private static final long serialVersionUID = 7848912143156628418L;
    ...
    public DefaultPagination1(int pageSize, int pageNumber, int totalNumberOfElements, List<T> elements) {
        this(pageSize, pageNumber, totalNumberOfElements, elements, new HashMap<String, Object>());
    }

    public DefaultPagination1(int pageSize, int pageNumber, int totalNumberOfElements, List<T> elements, Map<String, Object> model) {
