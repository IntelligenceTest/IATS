...
<title>AutoStreets后台系统-竞拍人最高出价记录查询</title>
...
<div class="mainblock">
 <%@ include file="/jsp/common/sub-menu.jsp"%> --%>
    <div class="m_content">
        <form:form action="${ctx }/report/bidder-log" method="post" commandName="auctionVehicleVO" id="bidderLogsForm">
    ...
    <div class="rbody">
        <div class="tbl_ctrl" style="width:99.3%;">
                 <b><font size="3" color="black">&nbsp;&nbsp;&nbsp;拍卖报表竞拍人最高出价记录查询</font></b>
        </div>
...
$(document).ready(function (){
	...
	kkpager.generPageHtml({
		...
		//链接前部
		hrefFormer : '${ctx}/report/bidder-log',
		//设置每页显示条数
		isShowSelectPageSize : true,
		//链接算法
		getLink : function(n) {
			var queryString = $('#bidderLogsForm').serialize();
