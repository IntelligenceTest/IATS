...
@Controller
@RequestMapping("/adu")
public class AuctionDataUploadController extends BaseController {
    ...
    @RequiresPermissions("auct:adu:index")
    ...
    public String index(Pagination pagination, AuctionDataUploadVO auctionDataUploadVO, Model model) {
        ...
        auctionDataUploadVO.setUserId(getUser().getId());
    ...
    @RequiresPermissions("auct:adu:importFile")
    ...
    public JsonResult uploadFile(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            if (object != null) {
                ...
                return new JsonResult(false, "文件失效，请重新上传");
            }
    ...
    @RequiresPermissions("auct:adu:deleteFile")
    ...
    public JsonResult deleteFile(Integer auctionId) {
        ...
        if (auctionId != null) {
            boolean result = auctionDataUploadService.deleteUploadData(auctionId, getUser().getId());
            if (result) {
            ...
            return new JsonResult(true, "没有权限或没有数据！删除失败");
    ...
    @RequiresPermissions("auct:adu:view")
    ...
    public String getVehicleInfoByAuctionPersonList(Integer auctionId, String memberSid, String idCardNum,
        ...
        List<AuctionDataUploadVO> auctionDataUploads = auctionDataUploadService.getVehicleInfoByAuctionPerson(auctionId,
                memberSid, idCardNum, getUser().getId());
        model.addAttribute("auctionDataUploads", auctionDataUploads);
        return "adu/viewBymem/vehicle-list";
    }
    ...
    @RequiresPermissions("auct:adu:exportFile")
